  ...
  getSendParam(name, value) {
    ...
    switch (name) {
      case Characteristic.On:
        ...
        this.log("🔥 Updating ${code} isOn with ${value}");
        break;
      case Characteristic.ColorTemperature:
        ...
        this.log("🔥 Updating ${code} temperature with ${value}");
        break;
      case Characteristic.Brightness:
        {
          ...
          if ((!this.workMode || this.workMode.value === 'white' || this.workMode.value === 'light_white') && this._isHaveDPCodeOfBrightValue()) {
            ...
            this.log("🔥 Updating ${code} brightness with brightness ${value}");
          } else {
            var saturation;
            ...
            this.log("🔥 Updating ${code} brightness with hsv ${value}");
          }
        }
        break;
      case Characteristic.Hue:
        ...
        this.log("🔥 Updating ${code} hue with ${value}");
        break;
      default:
        break;
    }
